...
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Commands List</h2>
        </div>
        <div class="col-md-4">
            <div class="media">
                <div class="pull-left">
                ...
                <div class="media-body">
                    <h4 class="media-heading">Section One</h4>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading">Section Two</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                </div>
            </div>
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading">Section Three</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading">Service Nine (LG)</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo itaque ipsum sit harum.</p>
                </div>
            </div>
        </div>
